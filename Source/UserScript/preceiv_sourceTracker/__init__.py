...
ScriptFolder=ui.application.getapplicationpath()["userscript"]+"preceiv_sourceTracker\\"
...
class managerLinkWithSourcePosition:
    ...
    def AskUserToSelectASource(self):
        ...
        srcLst.sort()
        srcsellabel=_(u"Nom de la source")
        dialog_res=ui.application.getuserinput(_(u"Sélection d'une source"),_(u"Veuillez choisir la source :"),{srcsellabel : srcLst})
