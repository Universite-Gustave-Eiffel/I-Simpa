...
def process_output_files(outfolder, coreconf, import_data, resultsModificationLayers):
    ...
    if os.path.exists(mesh_path):
        ...
        nodes = data_module.data['XYZ']
        rooms = len(data_module.data['TetDOF'])
        tetrahedrons = data_module.data['TetDOF']
        print("nodes = ", nodes)
        print("rooms = ", rooms)
        print("tetrahedrons = ", tetrahedrons)
...
def main(call_python=True):
    ...
    import core.Diffusion_MD_fil_ao2
