...
class coreConfig(object):
    ...
    def __init__(self,xmlfilepath):
        ...
        self.const['do_abs_atmo'] = bool(int(simunode.getproperty("do_abs_atmo", "0")))
        self.const['stationary'] = bool(int(simunode.getproperty("stationary", "0")))
        self.const['imposed_abs_atmo']= bool(int(condition_atmospherique_node.getproperty("disable_absatmo_computation", "0")))
        self.const['abs_atmo']=condition_atmospherique_node.getpropertyfloat("absatmo")
