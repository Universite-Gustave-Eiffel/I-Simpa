...
1. **Right click** on the 'Surface receiver' root folder in the Data tree of the Scene tab and **Select** 'New scene face receiver'. A new surface receiver is created.
...
3. **Right click** on the 'Sound level' element and *Select** 'Calculate coustics parameters'. It opens a new window: **Keep** the default values, and **Select** 'OK'. It creates two new elements 'Schroeder curves' and 'Acoustic parameters'. **Select** the new elements to display the corresponding results.

4. **Right click** on the 'Advanced sound level' element and *Select** 'Calculate coustics parameters'. It opens a new window: **Keep** the default values, and **Select** 'OK'. It creates one new element 'Advanced acoustic parameters'. **Select** the element to display the corresponding results.
