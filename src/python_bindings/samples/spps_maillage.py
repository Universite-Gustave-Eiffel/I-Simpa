...
def push_tetraedres(maillage,tetralst):
    """
        Transforme un tableau python en structure de donn�es de maillage
    """
...
#D�finitions des sommets des t�tra�dres
...
#D�finition des t�trah�dres
#   _______________Sommets du t�tra�dre__    _Encombrement_    __4 faces du t�tra�dre_______________________________________
