...
#ifndef __ELEMENT_GABE_RECPS__
#define __ELEMENT_GABE_RECPS__



/** \file e_report_gabe_recps.h
 *  \brief Report file of receiver point. Level by source
 */

/**
 *  \brief Report file of receiver point. Level by source
 */
class E_Report_Gabe_Recps: public E_Report_Gabe
{
public:
	/**
	 ...
	 */
	E_Report_Gabe_Recps(Element* parent,wxString Nom,wxString Path);
	 ...
	 */
	E_Report_Gabe_Recps(Element* parent,wxXmlNode* nodeElement);
