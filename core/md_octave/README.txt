...
scene_elements.txt
Vertices index (1-n) of tetrahedral elements
A, B, C, D, IdVolume

scene_tetrafaces.txt
Material identifier of each tetrahedral faces and the volume identifier.
The face order follow the vertices order ex: I(B,C,D) J(A,C,D) K(A,B,D) L(A,B,C)
I, J, K, L, idVolume
